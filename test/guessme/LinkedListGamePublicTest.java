...
public class LinkedListGamePublicTest {
	...
	public void testPriorGuesses() {
		...
		gamerB.reset();
		assertEquals("test prior guesses", 1000, gamerB.getGuess());
		
		gamerB.updateGuess(3);
		assertEquals("test prior guesses", 1001, gamerB.getGuess());
		
		gamerB.updateGuess(2);
		assertEquals("test prior guesses", 1010, gamerB.getGuess());
		
		gamerB.updateGuess(2);
		assertEquals("test prior guesses", 1100, gamerB.getGuess());
		
		gamerB.updateGuess(2);
		assertEquals("test prior guesses", 2000, gamerB.getGuess());
		...
		gamerB.updateGuess(2);
		assertEquals("test prior guesses", 1011, gamerB.getGuess());
		
		gamerB.updateGuess(2);
		assertEquals("test prior guesses", 1022, gamerB.getGuess());
		
		gamerB.updateGuess(1);
		assertEquals("test prior guesses", 1101, gamerB.getGuess());
		
		gamerB.updateGuess(2);
		assertEquals("test prior guesses", 1110, gamerB.getGuess());
		
		gamerB.updateGuess(0);
		assertEquals("test prior guesses", 2001, gamerB.getGuess());
